...
model = EigenvalueProblemModel([2, 50, 50, 1], Sin, compose_psi, PDE_loss, lr=8e-3, start_eigenvalue=10.0)
try:
    model.train(driver, 10000, grid, perturb, int(30e3), max_required_loss=1e-3, rtol=0.01, fraction=6, reg_param = 1e-1)
